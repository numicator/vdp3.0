...
#PBS -P u86
#PBS -q normal
#PBS -l walltime=48:00:00,mem=64GB,ncpus=4,jobfs=256GB
#PBS -l storage=gdata/u86+gdata/xx92
#PBS -l other=gdata
#PBS -W umask=0007
#PBS -o /g/data/xx92/data/vdp3.0/TMP_GermlineCNVCaller/GermlineCNVCaller_8large.$split.out
#PBS -e /g/data/xx92/data/vdp3.0/TMP_GermlineCNVCaller/GermlineCNVCaller_8large.$split.err
...
--output-prefix callerl_WES.$split \
$tsvs
" >/g/data/xx92/data/vdp3.0/TMP_GermlineCNVCaller/GermlineCNVCaller_8large.$split.qsub
  
  qsub /g/data/xx92/data/vdp3.0/TMP_GermlineCNVCaller/GermlineCNVCaller_8large.$split.qsub
done