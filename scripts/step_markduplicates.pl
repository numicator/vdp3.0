...
$cmd .= " TMP_DIR=$dir_tmp MAX_RECORDS_IN_RAM=300000 OPTICAL_DUPLICATE_PIXEL_DISTANCE=2500 VALIDATION_STRINGENCY=LENIENT CREATE_INDEX=true I=$dir_merge_bam/$cohort-$individual.bwa.bam O=$dir_run/$cohort-$individual.duplicatemarked.bam M=$dir_run/$cohort-$individual.duplicatemetrics.txt";
